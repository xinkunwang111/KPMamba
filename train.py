...
# from escape import *  # noqa
from escape.apis import train_model
...
def main():
    ...
    model.to(f"cuda:{cfg.gpu_ids[0]}")
    #print(model)


    train_datasets = [build_dataset(cfg.data.train)]
    #output = model.backbone.forward(torch.randn(1, 3, 256, 256).to(f"cuda:{cfg.gpu_ids[0]}"))
    #print(output.shape)


    #import pdb
    #pdb.set_trace()  # 在你需要调试的地方设置断点
